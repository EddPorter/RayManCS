...
namespace RayManCS.Test {
  ...
  public class ColourTests {
    ...
    [TestMethod]
    public void Colour_Constructor_limits_blue_to_one() {
      float red = 0.0f;
      float green = 1.0f;
      float blue = 1.5f;
      ...
      Assert.AreEqual(colour.Blue, 1.0f, EPSILON);
    }

    [TestMethod]
    public void Colour_Constructor_limits_green_to_one() {
      float red = 0.0f;
      float green = 1.5f;
      float blue = 0.5f;
      ...
      Assert.AreEqual(colour.Green, 1.0f, EPSILON);
    }

    [TestMethod]
    public void Colour_Constructor_limits_red_to_one() {
      float red = 1.5f;
      float green = 1.0f;
      float blue = 0.5f;
      ...
      Assert.AreEqual(colour.Red, 1.0f, EPSILON);
    }
    ...
    public void Operator_Multipy_scales_colour_correctly() {
      ...
      Assert.AreEqual(scaledColour.Red, 1.0f, EPSILON);
    ...
    public void Operator_Add_combines_two_colours_correctly() {
      ...
      var newColour = lhs + rhs;
      Assert.AreEqual(1.0f, newColour.Red, EPSILON);
